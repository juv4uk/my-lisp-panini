...
evidence and retain the three-layer labeling there.
...
дослідницькі записи та зберігайте в них тришарове маркування.
...
- [bridge-to-my-lisp.md](bridge-to-my-lisp.md) enthält vorläufige
  Schnittstellenhypothesen; dies ist keine Entscheidung, My Lisp zu ändern.
