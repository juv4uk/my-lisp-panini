...
[`pratyaya.md`](../sastra/pratyaya.md) уточнює: умови застосування
...
- **[PANINI]** Шість `kAraka`-категорій — семантико-синтаксичні ролі,
  формально означені sūtra 1.4.23–55 (див. [`karaka.md`](../sastra/karaka.md)).
...
- **[PANINI]** `pratyAhAra` — позначення множини звуків через перший
  ...
  [`pratyahara.md`](../sastra/pratyahara.md)).
...
- **[PANINI]** `it`-звуки присутні у формальному записі (Dhātupāṭha,
  ...
  [`ontology.md`](../sastra/ontology.md) Рівень 3.
...
- **[PANINI]** Механізм успадкування слів між sūtra без повторення,
  ...
  1.3.11) — див. [`anuvrtti.md`](../sastra/anuvrtti.md).
...
- **[PANINI]** Aṣṭādhyāyī — впорядкована система правил із залежністю
  ...
  на форму, див. [`pratyaya.md`](../sastra/pratyaya.md)).
...
> **Історичний знімок, не поточна структура** (додано 2026-08-18, за
> знахідкою зовнішнього огляду Manus AI, `docs/Огляд.md` §8.4):
> дерево нижче зафіксоване на момент декларації v0.1 "завершено" і
> **більше не відповідає фактичній структурі репозиторію** — каталог
> `foundation/` з тих пір перейменовано на [`sastra/`](../sastra), а
> `machine/`/`registry/`/`research/`/`specs/` значно виросли й
> реорганізувались. Актуальну структуру дивіться напряму в репозиторії
> (`ls panini/`), не в цьому дереві — воно лишається тут як історичний
> артефакт milestone-декларації, не як карта.

```
panini/
├── README.md
├── foundation/          ⚠️ перейменовано на sastra/, див. примітку вище
